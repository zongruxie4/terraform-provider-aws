...
func TestAccTimestreamInfluxDBDBInstance_Identity_basic(t *testing.T) {
...
func TestAccTimestreamInfluxDBDBInstance_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccTimestreamInfluxDBDBInstance_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/DBInstance/basic_v6.43.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.43.0
func TestAccTimestreamInfluxDBDBInstance_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
