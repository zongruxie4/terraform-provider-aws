...
func TestAccS3BucketLifecycleConfiguration_Identity_basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/BucketLifecycleConfiguration/basic/"),
...
func TestAccS3BucketLifecycleConfiguration_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/BucketLifecycleConfiguration/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
...
func TestAccS3BucketLifecycleConfiguration_Identity_ExistingResource_basic(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/BucketLifecycleConfiguration/basic_v6.32.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
				},
				Check: resource.ComposeAggregateTestCheckFunc(
...
// Resource Identity was added after v6.32.0
func TestAccS3BucketLifecycleConfiguration_Identity_ExistingResource_noRefreshNoChange(t *testing.T) {
	ctx := acctest.Context(t)
