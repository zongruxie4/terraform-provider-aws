...
func testAccObservabilityAdminTelemetryEvaluation_identitySerial(t *testing.T) {
	t.Helper()

	testCases := map[string]func(t *testing.T){
		acctest.CtBasic:  testAccObservabilityAdminTelemetryEvaluation_Identity_basic,
		"RegionOverride": testAccObservabilityAdminTelemetryEvaluation_Identity_regionOverride,
	}

	acctest.RunSerialTests1Level(t, testCases, 0)
}

func testAccObservabilityAdminTelemetryEvaluation_Identity_basic(t *testing.T) {
...
func testAccObservabilityAdminTelemetryEvaluation_Identity_regionOverride(t *testing.T) {
	ctx := acctest.Context(t)
